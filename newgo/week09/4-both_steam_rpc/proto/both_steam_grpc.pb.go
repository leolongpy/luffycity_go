...
func (c *streamClient) Conversations(ctx context.Context, opts ...grpc.CallOption) (Stream_ConversationsClient, error) {
	stream, err := c.cc.NewStream(ctx, &Stream_ServiceDesc.Streams[0], "/Stream/Conversations", opts...)
	if err != nil {
		return nil, err
	}
...
func (x *streamConversationsClient) Send(m *StreamReq) error {
	return x.ClientStream.SendMsg(m)
}

func (x *streamConversationsClient) Recv() (*StreamRsp, error) {
	m := new(StreamRsp)
...
func (x *streamConversationsServer) Send(m *StreamRsp) error {
	return x.ServerStream.SendMsg(m)
}

func (x *streamConversationsServer) Recv() (*StreamReq, error) {
	m := new(StreamReq)
