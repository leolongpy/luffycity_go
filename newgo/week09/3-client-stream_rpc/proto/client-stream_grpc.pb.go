...
func (c *streamClientClient) RouteList(ctx context.Context, opts ...grpc.CallOption) (StreamClient_RouteListClient, error) {
	stream, err := c.cc.NewStream(ctx, &StreamClient_ServiceDesc.Streams[0], "/StreamClient/RouteList", opts...)
	if err != nil {
		return nil, err
	}
...
func (x *streamClientRouteListClient) Send(m *StreamReq) error {
	return x.ClientStream.SendMsg(m)
}

func (x *streamClientRouteListClient) CloseAndRecv() (*SimpleRsp, error) {
...
func (x *streamClientRouteListServer) SendAndClose(m *SimpleRsp) error {
	return x.ServerStream.SendMsg(m)
}

func (x *streamClientRouteListServer) Recv() (*StreamReq, error) {
	m := new(StreamReq)
