...
type SimpleClient interface {
	Route(ctx context.Context, in *SimpleReq, opts ...grpc.CallOption) (*SimpleRsp, error)
}
...
func (c *simpleClient) Route(ctx context.Context, in *SimpleReq, opts ...grpc.CallOption) (*SimpleRsp, error) {
	out := new(SimpleRsp)
...
type SimpleServer interface {
	Route(context.Context, *SimpleReq) (*SimpleRsp, error)
...
func (UnimplementedSimpleServer) Route(context.Context, *SimpleReq) (*SimpleRsp, error) {
...
func _Simple_Route_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(SimpleServer).Route(ctx, req.(*SimpleReq))
	}
