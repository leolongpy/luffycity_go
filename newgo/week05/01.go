...
//)
//
//func calcSalary(ratio float32, factor int, info map[string]interface{}) (username string, bonus int, nextSalary float32) {
...
//}
//
//func epibolyCalcSalary(ratio float32, factor int, info map[string]interface{}) (username string, bonus int, nextSalary float32) {
//	salary := info["salary"].(int)
//	username = info["name"].(string)
//	bonus = salary * factor
...
//	var factor int
//
//	empoyee1 := map[string]interface{}{
//		"name" : "Alex",
//		"level":8,
//		"salary":40000,
//	}
//	empoyee2 := map[string]interface{}{
//		"name" : "Boyle",
//		"level":7,
//		"salary":30000,
//	}
//	epiboiy1 := map[string]interface{}{
//		"name" : "张三",
//		"level":0,
//		"salary":10000,
//	}
//	employeeInfo = append(employeeInfo,empoyee1,empoyee2)
//	fmt.Printf("员工当前薪资\n")
...
//	}
//	username,bonus,nextSalary := epibolyCalcSalary(0,2,epiboiy1)
