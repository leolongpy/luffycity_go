...
func (x *SimpleReq) GetData() string {
	if x != nil {
		return x.Data
	}
	return ""
...
func (x *SimpleRsp) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*SimpleRsp) ProtoMessage() {}

func (x *SimpleRsp) ProtoReflect() protoreflect.Message {
	mi := &file_simple_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use SimpleRsp.ProtoReflect.Descriptor instead.
func (*SimpleRsp) Descriptor() ([]byte, []int) {
	return file_simple_proto_rawDescGZIP(), []int{1}
}

func (x *SimpleRsp) GetCode() int32 {
	if x != nil {
		return x.Code
	}
	return 0
...
func (x *SimpleRsp) GetValue() string {
	if x != nil {
		return x.Value
	}
	return ""
...
var file_simple_proto_rawDesc = []byte{
	...
	0x72, 0x6f, 0x74, 0x6f, 0x22, 0x1f, 0x0a, 0x09, 0x53, 0x69, 0x6d, 0x70, 0x6c, 0x65, 0x52, 0x65,
	0x71, 0x12, 0x12, 0x0a, 0x04, 0x64, 0x61, 0x74, 0x61, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52,
	0x04, 0x64, 0x61, 0x74, 0x61, 0x22, 0x35, 0x0a, 0x09, 0x53, 0x69, 0x6d, 0x70, 0x6c, 0x65, 0x52,
	...
	0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x05, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x32, 0x54, 0x0a, 0x06,
	0x53, 0x69, 0x6d, 0x70, 0x6c, 0x65, 0x12, 0x4a, 0x0a, 0x05, 0x52, 0x6f, 0x75, 0x74, 0x65, 0x12,
	0x11, 0x2e, 0x73, 0x69, 0x6d, 0x70, 0x6c, 0x65, 0x2e, 0x53, 0x69, 0x6d, 0x70, 0x6c, 0x65, 0x52,
	0x65, 0x71, 0x1a, 0x11, 0x2e, 0x73, 0x69, 0x6d, 0x70, 0x6c, 0x65, 0x2e, 0x53, 0x69, 0x6d, 0x70,
	0x6c, 0x65, 0x52, 0x73, 0x70, 0x22, 0x1b, 0x82, 0xd3, 0xe4, 0x93, 0x02, 0x15, 0x22, 0x10, 0x2f,
	0x76, 0x31, 0x2f, 0x73, 0x69, 0x6d, 0x70, 0x6c, 0x65, 0x2f, 0x72, 0x6f, 0x75, 0x74, 0x65, 0x3a,
...
var file_simple_proto_goTypes = []interface{}{
	(*SimpleReq)(nil), // 0: simple.SimpleReq
	(*SimpleRsp)(nil), // 1: simple.SimpleRsp
}
var file_simple_proto_depIdxs = []int32{
	0, // 0: simple.Simple.Route:input_type -> simple.SimpleReq
	1, // 1: simple.Simple.Route:output_type -> simple.SimpleRsp
